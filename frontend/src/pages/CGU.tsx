...
export function CGU() {
  usePageTitle("Conditions générales d'utilisation", {
    description:
      "Conditions générales d'utilisation de Djassa : compte, commandes, séquestre, commission et résiliation.",
  });
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <Prose>
        ...
        <p>
          ...
          Djassa, un marché en ligne mettant en relation des acheteurs et des
        ...
        <p>
          ...
          est alors bloqué sous séquestre par Djassa. Le vendeur dispose de 72
        ...
        <h2>4. Commission</h2>
        <p>
          Djassa prélève une commission de 5% du montant de chaque commande
        ...
        <p>
          ...
          page <Link to="/verification">Vérification</Link>. Djassa se réserve le
        ...
        <p>
          ...
          litige par l'équipe Djassa.
        </p>

        <h2>7. Contenus et annonces</h2>
        <p>
          Chaque vendeur est seul responsable de l'exactitude des titres,
          descriptions, prix et photos qu'il publie. Djassa peut retirer une
        ...
        <h2>8. Résiliation</h2>
        <p>
          Un utilisateur peut cesser d'utiliser Djassa à tout moment. Djassa peut
